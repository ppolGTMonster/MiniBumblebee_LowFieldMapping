 ...
 */
#ifndef BRACCIOV2SLOWED_H_
#define BRACCIOV2SLOWED_H_
...
class Braccio {
  public:
    ...
    void setAllNowSynchron(int b, int s, int e, int w, int w_r, int g);
    void setAllNowSoftStartUp(int b, int s, int e, int w, int w_r, int g);
    void update();
