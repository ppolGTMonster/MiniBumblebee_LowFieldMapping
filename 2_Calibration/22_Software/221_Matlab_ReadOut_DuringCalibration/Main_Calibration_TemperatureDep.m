...
%       Goal: determine Temperature Dependence 
% 
...
num_AQ = 100;    %  Number of measured Points per Magnetic Field Step. Each Point is equivalent to an Arith.Average of "num_Averages_HallSens" Points
...
save_name = ['Temperature_Dep_' HallSensor_Type '_' measurend_Direction '_Date_' save_name '.mat'];
